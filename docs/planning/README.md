...
LLM- and agent-generated planning artifacts for Covered live here (architecture notes, prototype/MVP breakdowns, spike write-ups, decision records, etc.).

| Doc | Role |
|-----|------|
| [product-vision.md](./product-vision.md) | Long-term offering and boundaries |
| [product-phases.md](./product-phases.md) | **Prototype vs MVP vs platform** — current phase is **prototype** (`v0.x`) |
